...
NAMESPACE="mongo"
SERVICE_ACCOUNT="mongo-sa"
ROLE_NAME="mongodb-staging-restore-role"
TRUST_POLICY_FILE="$HOME/mongodb-sync/scripts/policy/staging-restore-trust-policy.json"
S3_POLICY_FILE="$HOME/mongodb-sync/scripts/policy/staging-restore-s3-policy.json"
REGION="us-east-1"
...
echo "📝 Updating S3 inline policy..."
aws iam put-role-policy \
  --role-name "$ROLE_NAME" \
  --policy-name "staging-restore-s3-policy" \
...
echo "🎉 Staging Restore IRSA setup complete!"
